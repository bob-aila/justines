...
header('location: ../index2.php#index.php?pages=2');
}
?>
            ...
            <div class="panel-body">  
                 ...
                 <?php //include'navigator.php';?>
					...
					?>
					 ...
					 <form class="form-horizontal well span6" action="booking/personalinfo.php" method="post"  name="personal" style="margin-left:20px">
					 <fieldset >
