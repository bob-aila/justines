        ...
        <table class="table table-hover">
          ...
          <tfoot>
               <tr>
                   ...
                   <td align="left">
                  <h5><b> Ksh.<?php echo $payable= $days*$result->price; ?></b></h5>
...
If you have any questions to <strong><?php echo $result->location;?></strong> , please email at gaila8218@gmail.com or call +254 780410173 we can arrange for a pic-up if requested
<br/><br/>
