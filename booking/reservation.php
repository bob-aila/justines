      ...
      <!--<div class="jumbotron">-->
        <div class="">
          ...
          <td valign="top" class="body" style="padding-bottom:10px;">
           ...
           <p>
           <img src="img/logo1.png" height="60px" width="60px">
           ...
           Greetings from JIJO BNBs Kenya.<br/>
           Please keep the invoice of your reservation:<br/>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            session_start(); 
             ...
             $arival   = $_SESSION['from']; 
              ...
              $query = $conn->query("SELECT *,typeName FROM room ro, roomtype rt WHERE ro.typeID = rt.typeID and roomNo =". $roomid);
          ...
          <tfoot>
               <tr>
                   ...
                   <td align="left">
                  <h5><b> Ksh.<?php echo $payable; ?></b></h5>
...
If you have any questions to <strong><?php echo $location ;?></strong> , please email at gaila8218@gmail.com or call +254 780410173 we can arrange for a pic-up if requested
<br/><br/>
