...
<link rel="shortcut icon" type="img/icon" href="\justines/img/icon.png"/>
	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>admin/index.php"><img src="\justines/img/logo2.png" height="7%" width="25%"></a>
	        </div>
