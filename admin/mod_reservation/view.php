...
$id=$_GET['id'];
$mydb->setQuery("SELECT *,roomName,ro.Adults,Children,firstname,lastname,roomImage,address FROM reservation re,room ro,guest gu  WHERE re.roomNo = ro.roomName AND re.guest_id=gu.guest_id AND reservation_id=".$id);
