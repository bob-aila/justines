	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php"><img src="\justines/img/logo2.png" height="7%" width="25%"></a>
	        </div>
				...
				<!-- <img  width="1100px" hieght="100px" class="img-rounded"/> -->
					<div class="media">
					  <a class="pull-left" href="#">
					    <img class="media-object" src="<?php echo WEB_ROOT; ?>img/banner6.png" alt="...">
					  </a>
					</div>
				</div>
			</div>
