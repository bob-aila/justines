	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="index.php"><img src="img/logo2.png" height="7%" width="25%"></a>
	        </div>
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            <li><a href="index.php#home">Home</a></li>
	            <li><a href="index.php?page=2">Gallery</a></li>
	            <li><a href="index.php?page=5">Room and Rates</a></li>
	            <li><a href="index.php?page=4">Contact us</a></li>
	            <li><a href="index.php?page=7">Site Map</a></li>			              
	          </ul>
	        </div><!-- /.nav-collapse -->
	      </div><!-- /.container -->
	    </div><!-- /.navbar -->
...
<!--End of Header-->
<div class="container">
          <section id="index.php?pages=1">
               <?php
                include_once 'booking/booking.php';
               ?>
            </section>
            <section id="index.php?pages=2">
                <?php
                  include_once 'booking/personalinfo.php';
                ?> 
            </section>
            <section id="index.php?pages=3">
                <?php
                  include_once 'booking/payment.php';
                ?> 
            </section>
            <section id="index.php?pages=4">
                <?php
                    include_once 'booking/reservation.php';		
                ?> 
            </section>
            <section id="index.php?pages=5">
                <?php
